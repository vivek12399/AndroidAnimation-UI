 ...
 */
class AcceptedLeadListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val deleteIcon: Drawable? = ContextCompat.getDrawable(requireContext(), R.drawable.baseline_delete_24)
        val archiveIcon: Drawable? = ContextCompat.getDrawable(requireContext(), R.drawable.baseline_remove_red_eye_24)
        ...
        val archiveBackgroundColor = Color.parseColor("#128807")
        ...
        if (ROLE==1){
            ...
            leadsAdapter = LeadsAdapter(requireContext(),leads,binding.leadRView,onAccept = {
                ...
                findNavController().navigate(R.id.action_LeadsAcceptListFragment_to_LeadsDetailsFragment, bundle)
            }, onDecline = {
