...
import com.digitalsoch.databinding.FragmentPendingLeadListBinding
 ...
 */
class PendingLeadListFragment : Fragment() {

    private var _binding: FragmentPendingLeadListBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPendingLeadListBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val archiveBackgroundColor = Color.parseColor("#FFC107")
        ...
        if (ROLE==1){
            ...
            leadsAdapter = LeadsAdapter(requireContext(),leads,binding.leadRView, onAccept = {
                ...
                val bundle = Bundle().apply {
                    putString("status", "0")
                    putSerializable("lead", it) }
                findNavController().navigate(R.id.action_LeadsPendingListFragment_to_LeadsDetailsFragment, bundle)
            })
